...
**Projects** shows the GitLab projects the token's user is a member of, most recently active
first (up to 50).
...
- Click a card for project details and its recent pipelines; the external-link icon opens the
  project in GitLab.
