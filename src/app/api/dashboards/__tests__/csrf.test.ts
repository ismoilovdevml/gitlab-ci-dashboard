...
const cases: Array<[string, string, Handler]> = [
  ['POST', 'http://localhost/api/dashboards', POST],
  ['PUT', 'http://localhost/api/dashboards', PUT],
  ['DELETE', 'http://localhost/api/dashboards?id=d1', DELETE],
];

describe('/api/dashboards CSRF enforcement', () => {
  beforeAll(() => {
